...
void AGridActor::OnConstruction(const FTransform& Transform)
{
    ...
    {
        UE_LOG(LogTemp, Warning, TEXT("Grid size is too small on at least one side"));
    ...
    UE_LOG(LogTemp, Warning, TEXT("Construction: ScaleX: %f, ScaleY: %f, CellSize: %f"), ScaleX, ScaleY, CellSize);
